...
public class LoanCalc {
    ...
    public static void main(String[] args) {
		...
		System.out.printf("BRUTE FORCE: Best payment found: %.4f%n", payment);
		...
		System.out.printf("BI-SECTION: Best payment found: %.4f%n", newPayment);
        System.out.printf("Final balance after %d payments: %.4f%n", n, finalBalance);
		System.out.printf("iteration Counter: %d%n", iterationCounter);
	...
	static double bisectionSearch (double loan,
		...
		// hi: a conservative upper bound that will usually overpay -> balance < 0
		double hi = loan * 2.0;
		...
		System.out.printf("Abount to return payment of  %.2f%n",(lo + hi) / 2.0 );
		return (lo + hi) / 2.0;
	}
